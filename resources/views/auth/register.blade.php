                ...
                <div class="card bg-secondary shadow border-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            <h3>{{ __('CADASTRO') }}</h3>
                            <small>{{ __('Informe seus dados') }}</small>
                        </div>
                        <form role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control" placeholder="{{ __('Confirmar senha') }}" typare="password" name="password_confirmation" required>
                                </div>
                            </div>
                            
                            <div class="text-center">
                                <button type="submit" class="btn btn-default text-uppercase mt-4">{{ __('criar conta') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
