...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('Este é o seu perfil. Aqui você pode editar seus dados'),
        'class' => 'col-lg-7'
    ])   
                ...
                <div class="card card-profile shadow">
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="mt-5 text-center">
                            ...
                            <h3 class="font-weight-light">{{ auth()->user()->email}}</h3>

                            
                            <hr class="my-4" />
                            
                            <a href="{{route('home')}}">{{ __('Voltar para dashboard') }}</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="input-password-confirmation">{{ __('Confirme sua nova senha') }}</label>
                                    <input type="password" name="password_confirmation" id="input-password-confirmation" class="form-control form-control-alternative" placeholder="{{ __('Confirme sua nova senha') }}" value="" required>
                                </div>

                                <div class="text-center">
                                    <button type="submit" class="btn btn-success mt-4 text-uppercase">{{ __('Alterar senha') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
